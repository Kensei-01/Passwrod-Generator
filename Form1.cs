    ...
    public partial class Form1 : Form
    {
        ...
        private void btnGeneratePw_Click_1(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                if (includeBigLetter && includeSpecialChars)
                {
